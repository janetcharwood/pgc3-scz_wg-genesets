...
in_dir_path = root_dir + '/processed/GENE_SETS/GO'

out_dir_path = root_dir + '/processed/GENE_SETS/GO/GO_MAGMA_FORMAT'

# define log file path
log_fname = root_dir + '/logs/GO_gene_sets_to_Magma.log'

outfile_type = '10-2000_MAGMA.txt'
...
##########################################
        ...
        print 'number of gene sets with 10-2000 genes in', os.path.basename(in_fname),'=', count
        log_file.write('number of gene sets with 10-2000 genes in'+ os.path.basename(in_fname) + '=' + str(count) + '\n')
